                            ...
                            <div class="widget-body">
                                <address class="contact-block">
                                    <ul>
                                        ...
                                        <li><i class="pe-7s-mail"></i> <a href="mailto:demo@plazathemes.com">duydvph46536@fpt.edu.vn</a></li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="copyright-text text-center">
                            <p>&copy; 2025 <b>Poly Shop</b> Được tạo  <i class="fa fa-heart text-danger"></i> bởi <b>Đỗ Duy</b></a></p>
                        </div>
                    </div>
                </div>
            </div>
